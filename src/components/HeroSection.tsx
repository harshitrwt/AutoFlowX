    ...
    <section className="relative bg-white dark:bg-gray-900 pt-20 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <div className={`inline-flex items-center px-3 sm:px-4 py-2 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-full text-blue-700 dark:text-blue-300 text-sm font-medium mb-6 ${isLoaded ? 'animate-fade-up' : 'opacity-0'}`}>
          ...
          <p className={`text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed px-4 ${isLoaded ? 'animate-fade-up animate-delay-400' : 'opacity-0'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-16 px-4">
            <div className={`bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100 dark:border-gray-700 ${isLoaded ? 'animate-fade-up animate-delay-700' : 'opacity-0'}`}>
            ...
            <div className={`bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg border border-gray-100 dark:border-gray-700 ${isLoaded ? 'animate-fade-up animate-delay-800' : 'opacity-0'}`}>
