    ...
    <section id="features" className="py-12 sm:py-20 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
          <div>
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            {features.slice(1, 3).map((feature, index) => (
              <div key={index} className="bg-white dark:bg-gray-900 rounded-xl p-4 sm:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="flex items-center mb-4">
                  {feature.icon}
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white ml-4">{feature.title}</h3>
                </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          {features.slice(3).map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center mb-6">
                {feature.icon}
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white ml-4">{feature.title}</h3>
              </div>
