  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20 dark:opacity-30">
      ...
      <div className="absolute top-32 right-20 animate-pulse" style={{ animationDelay: '1s', animationDuration: '4s' }}>
        <svg width="70" height="70" viewBox="0 0 24 24" fill="currentColor" className="text-blue-500 dark:text-blue-300">
      ...
      <div className="absolute bottom-32 left-20 animate-spin" style={{ animationDelay: '2s', animationDuration: '8s' }}>
        <svg width="65" height="65" viewBox="0 0 24 24" fill="currentColor" className="text-orange-600 dark:text-orange-400">
      ...
      <div className="absolute top-40 left-1/2 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '3.5s' }}>
        <svg width="55" height="55" viewBox="0 0 24 24" fill="currentColor" className="text-gray-800 dark:text-gray-200">
      ...
      <div className="absolute bottom-20 right-10 animate-pulse" style={{ animationDelay: '1.5s', animationDuration: '5s' }}>
        <svg width="80" height="80" viewBox="0 0 24 24" fill="currentColor" className="text-orange-500 dark:text-orange-300">
      ...
      <div className="absolute top-60 right-32 animate-spin" style={{ animationDelay: '3s', animationDuration: '6s' }}>
        <svg width="50" height="50" viewBox="0 0 24 24" fill="currentColor" className="text-cyan-500 dark:text-cyan-300">
      ...
      {/* Node.js Logo */}
      <div className="absolute bottom-40 left-1/3 animate-bounce" style={{ animationDelay: '2.5s', animationDuration: '4s' }}>
        <svg width="65" height="65" viewBox="0 0 24 24" fill="currentColor" className="text-green-600 dark:text-green-400">
      ...
      {/* MongoDB Logo */}
      <div className="absolute top-80 left-1/4 animate-pulse" style={{ animationDelay: '4s', animationDuration: '3s' }}>
        <svg width="45" height="45" viewBox="0 0 24 24" fill="currentColor" className="text-green-500 dark:text-green-300">
          <path d="M17.2 13.5c0-4.5-3.9-8.2-8.7-8.2S-.2 9-.2 13.5c0 3.6 2.2 6.7 5.3 8v.4c0 .6.5 1.1 1.1 1.1s1.1-.5 1.1-1.1v-.4c3.1-1.3 5.3-4.4 5.3-8zm-8.7-6.6c3.7 0 6.7 3 6.7 6.6 0 2.8-1.7 5.2-4.2 6.2v-12.8zm-2 12.8c-2.5-1-4.2-3.4-4.2-6.2 0-3.6 3-6.6 6.7-6.6v12.8z"/>
        </svg>
      </div>
    </div>
  );
